...
<html lang="ru">
  <head>
    ...
    <title> Автомобильная химия AG-Tech - Aliance Production</title>
  </head>

  <body class="blogmodern">
    <div class="mobile-menu">
      <ul class="mobile-menu-nav">
        ...
        <li class="mobile-menu-nav-item"><a href="news" class="mobile-menu-nav-link">Новости</a></li>
